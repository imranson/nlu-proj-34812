...
python code/train_av-4.py --max_len 512 --margin 0.75 --epochs 300 --batch_size 16 --lr 1e-5 --save_model
python code/train_av-4.py --max_len 512 --margin 1 --epochs 300 --batch_size 16 --lr 1e-5 --save_model
