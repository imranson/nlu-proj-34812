...
# pip install numpy pandas torch transformers scikit-learn sentencepiece protobuf
...
def train(args):
    ...
    if False: #args.fp16 and device.type == "cuda":
